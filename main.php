...
if (!is_object($xoopsUser) || !is_object($xoopsModule) || !$xoopsUser->isAdmin($xoopsModule->mid())) {
    ...
    if ('list' == $op) {
        ...
        echo '<ul><li>'
             . _MD_SYSAVATARS
             . ' ('
             . sprintf(_NUMIMAGES, '<b>' . $savatar_count . '</b>')
             . ') [<a href="admin.php?fct=avatars&amp;op=listavt&amp;type=S">'
             . _LIST
             . '</a>]</li><li>'
             . _MD_CSTAVATARS
             . ' ('
             . sprintf(_NUMIMAGES, '<b>' . $cavatar_count . '</b>')
             . ') [<a href="admin.php?fct=avatars&amp;op=listavt&amp;type=C">'
             . _LIST
             . '</a>]</li></ul>';
    ...
    if ('listavt' == $op) {
        ...
        $type = (isset($_GET['type']) && 'C' == $_GET['type']) ? 'C' : 'S';
        ...
        if ('S' == $type) {
            foreach (array_keys($avatars) as $i) {
                ...
                echo '<table class="outer" cellspacing="1" width="100%"><tr><td align="center" width="30%" rowspan="6"><img src="'
                     . XOOPS_UPLOAD_URL
                     . '/'
                     . $avatars[$i]->getVar('avatar_file')
                     . '" alt=""></td><td class="head">'
                     . _IMAGENAME, '</td><td class="even"><input type="hidden" name="avatar_id[]" value="'
                                   . $id
                                   . '"><input type="text" name="avatar_name[]" value="'
                                   . $avatars[$i]->getVar('avatar_name', 'E')
                                   . '" size="20" maxlength="255"></td></tr><tr><td class="head">'
                                   . _IMAGEMIME
                                   . '</td><td class="odd">'
                                   . $avatars[$i]->getVar('avatar_mimetype')
                                   . '</td></tr><tr><td class="head">'
                                   . _MD_USERS
                                   . '</td><td class="even">'
                                   . $avatars[$i]->getUserCount()
                                   . '</td></tr><tr><td class="head">'
                                   . _IMGWEIGHT
                                   . '</td><td class="odd"><input type="text" name="avatar_weight[]" value="'
                                   . $avatars[$i]->getVar('avatar_weight')
                                   . '" size="3" maxlength="4"></td></tr><tr><td class="head">'
                                   . _IMGDISPLAY
                                   . '</td><td class="even"><input type="checkbox" name="avatar_display[]" value="1"';

                if (1 == $avatars[$i]->getVar('avatar_display')) {
                    echo ' checked';
                }
            ...
            foreach (array_keys($avatars) as $i) {
                echo '<table cellspacing="1" class="outer" width="100%"><tr><td width="30%" rowspan="6" align="center"><img src="' . XOOPS_UPLOAD_URL . '/' . $avatars[$i]->getVar('avatar_file') . '" alt=""></td><td class="head">' . _IMAGENAME, '</td><td class="even"><a href="'
                                                                                                                                                                                                                                                      . XOOPS_URL
                                                                                                                                                                                                                                                      . '/userinfo.php?uid=';

                $userids = $avtHandler->getUser($avatars[$i]);

                echo $userids[0]
                     . '">'
                     . $avatars[$i]->getVar('avatar_name')
                     . '</a></td></tr><tr><td class="head">'
                     . _IMAGEMIME
                     . '</td><td class="odd">'
                     . $avatars[$i]->getVar('avatar_mimetype')
                     . '</td></tr><tr><td class="head">&nbsp;</td><td align="center" class="even"><a href="admin.php?fct=avatars&amp;op=delfile&amp;avatar_id='
                     . $avatars[$i]->getVar('avatar_id')
                     . '&amp;user_id='
                     . $userids[0]
                     . '">'
                     . _DELETE
    ...
    if ('save' == $op) {
        ...
        if ($count > 0) {
            ...
            for ($i = 0; $i < $count; $i++) {
                $avatar = $avtHandler->get($avatar_id[$i]);
    ...
    if ('addfile' == $op) {
        ...
        $uploader = new XoopsMediaUploader(XOOPS_UPLOAD_PATH, ['image/gif', 'image/jpeg', 'image/pjpeg', 'image/x-png', 'image/png'], 500000);
    ...
    if ('delfile' == $op) {
        ...
        xoops_confirm(['op' => 'delfileok', 'avatar_id' => (int)$_GET['avatar_id'], 'fct' => 'avatars', 'user_id' => $user_id], 'admin.php', _MD_RUDELIMG);
    ...
    if ('delfileok' == $op) {
        ...
        if (isset($user_id) && 'C' == $avatar->getVar('avatar_type')) {
